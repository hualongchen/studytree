...
import com.lemon.queue.utils.SpringContextUtil;
 ...
 *
 */
public class LemonMessageListener {

	private static final Log LOG = LogFactory.getLog(LemonMessageListener.class);
	...
	public static void main(String[] args) {
		...
		synchronized (LemonMessageListener.class) {
			while (true) {
				try {
					LemonMessageListener.class.wait();
